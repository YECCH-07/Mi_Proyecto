...
export default function AdminDashboard() {
    ...
    if (isLoading && activeTab === 'denuncias') return <div className="text-center p-10">Cargando Dashboard...</div>;
    if (error && activeTab === 'denuncias') return <div className="text-center p-10 text-red-500">Error: {error}</div>;
