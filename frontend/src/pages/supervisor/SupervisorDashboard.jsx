...
export default function SupervisorDashboard() {
    ...
    const fetchData = async () => {
        try {
            setIsLoading(true);
            const [denunciasData, areasData] = await Promise.all([
            ...
            setStats({ statusCounts, total: records.length });
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="mb-6">
                <h1 className="text-3xl font-bold text-primary">Panel de Supervisor</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div className="lg:col-span-1 bg-white p-6 rounded-lg shadow-lg">
                    ...
                    {denuncias.length > 0 ? <Pie data={chartData} /> : <p>No hay datos.</p>}
                </div>
                <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-lg">
                    <h2 className="text-xl font-bold mb-4">Últimas Denuncias (Todas)</h2>
                    <p className="text-sm text-gray-600 mb-4">Denuncias de todos los ciudadanos para asignar y supervisar</p>
