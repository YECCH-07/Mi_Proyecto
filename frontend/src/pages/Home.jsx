            ...
            <div className="relative z-10">
                ...
                <div className="container mx-auto px-4 py-16">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
                        <Link
                            to="/consulta"
                            className="bg-white/60 hover:bg-white/80 text-primary font-bold py-4 px-8 rounded-lg shadow-xl backdrop-blur-lg transition transform hover:scale-105 text-center"
                        >
                            🔍 Consultar mi Denuncia
                        </Link>
                        <Link
                            to="/register"
                            className="bg-primary/70 hover:bg-primary/90 text-white font-bold py-4 px-8 rounded-lg shadow-xl backdrop-blur-lg transition transform hover:scale-105 text-center"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        <div className="bg-white/60 backdrop-blur-lg p-8 rounded-lg shadow-xl text-center transform hover:scale-105 hover:bg-white/80 transition">
                    ...
                    {/* How it Works */}
                    <div className="bg-white/65 backdrop-blur-lg rounded-lg shadow-xl p-8 mb-16">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="bg-white/60 backdrop-blur-lg p-4 rounded-lg shadow-lg hover:shadow-xl hover:bg-white/80 transition transform hover:scale-105">
                    ...
                    {/* Final CTA */}
                    <div className="bg-white/65 backdrop-blur-lg text-gray-800 rounded-lg shadow-xl p-8 text-center mb-8">
