...
try {
    ...
    echo json_encode(["status" => "success", "message" => "✓ Base de datos '$db_name' creada/verificada"]) . "\n";
    ...
    echo json_encode(["status" => "success", "message" => "✓ Todas las tablas creadas/verificadas"]) . "\n";
    ...
    if ($count == 0) {
        ...
        echo json_encode(["status" => "success", "message" => "✓ Categorías iniciales insertadas (8 categorías)"]) . "\n";
    } else {
        echo json_encode(["status" => "info", "message" => "✓ Categorías ya existen ($count categorías)"]) . "\n";
    }
    ...
    if ($count == 0) {
        ...
        $conn->exec($areas_sql);
        echo json_encode(["status" => "success", "message" => "✓ Áreas municipales iniciales insertadas (5 áreas)"]) . "\n";
    } else {
        echo json_encode(["status" => "info", "message" => "✓ Áreas municipales ya existen ($count áreas)"]) . "\n";
    }
    ...
    if ($count == 0) {
        ...
        echo json_encode(["status" => "success", "message" => "✓ Usuario administrador creado (admin@municusco.gob.pe / admin123)"]) . "\n";
    } else {
        echo json_encode(["status" => "info", "message" => "✓ Usuario administrador ya existe"]) . "\n";
    }
